        ...
        public static class ExpressionBuilder
        {
                        ...
                        case 0:
                            {
                                ...
                                if (mcToken != null)
                                {
                                    ...
                                    else if (i == tokens.Count - 1 || tokens[i + 1] is PointToken)
                                    {
                                        ...
                                        {
                                            PropertyInfo pi = result.Type.GetPropertyInfo(mcToken.StrValue);
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            if (result.Type.MethodExists(mcToken.StrValue)) { state = 2; methodToken = mcToken; }
                                            else if (i == 0) result = CreateConstantExpression(mcToken, tokens.Count == 1 ? recommendedType : null);
                        ...
                        case 2:
                            {
                                ...
                                if (brToken != null)
                                {
                                    ...
                                    if (methodToken != null)
                                    {
                                        MethodInfo mi = result.Type.GetMethodInfo(methodToken.StrValue, 0);
            ...
            private static Expression CreateConstantExpression(MemberOrConstantToken mcToken, Type recommendedType)
            {
                ...
                if (recommendedType != null)
                    recommendedType.ConvertFromString(mcToken.StrValue,out obj);
                else
                    do
                    {
                        if (typeof(int).ConvertFromString(mcToken.StrValue,out obj)) break;
                        if (typeof(float).ConvertFromString(mcToken.StrValue, out obj)) break;
                        if (typeof(bool).ConvertFromString(mcToken.StrValue, out obj)) break;
                        if (typeof(DateTime).ConvertFromString(mcToken.StrValue, out obj)) break;
                        if (typeof(string).ConvertFromString(mcToken.StrValue, out obj)) break;
                    }
                    while (false);
